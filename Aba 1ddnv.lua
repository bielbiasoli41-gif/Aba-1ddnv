...
return function(ContentContainer, LocalPlayer, Players, RunService, MarketplaceService, startTime)
    ...
    local discordTop = createLabel("https://discord.gg/4jmSBKqR", ContentContainer, 12, false)
    ...
    -- Discord link
    local discordBottom = createLabel("https://discord.gg/4jmSBKqR", ContentContainer, 12, false)
    ...
    createButton("Copy Link", function()
        setclipboard("https://discord.gg/4jmSBKqR")
